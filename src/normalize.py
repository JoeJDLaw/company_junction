...
LEGAL_SUFFIXES = {
    ...
    "llc": "LLC", "l.l.c.": "LLC", "limited liability company": "LLC",
    ...
    "pc": "PC", "professional corporation": "PC",
    "co": "CO", "co.": "CO", "company": "CO",
    "gmbh": "GMBH", "gesellschaft mit beschränkter haftung": "GMBH"
}

# Parentheses content that should never be treated as company names
PARENTHESES_BLACKLIST = {
    "paystub", "pay stubs", "paystubs", "not sure", "unsure", "unknown", 
    "staffing agency", "temp", "temporary", "delaware", "california", "new york",
    "florida", "texas", "ohio", "illinois", "pennsylvania", "michigan", "georgia",
    "north carolina", "virginia", "washington", "massachusetts", "indiana", "tennessee",
    "missouri", "maryland", "colorado", "wisconsin", "minnesota", "alabama", "south carolina",
    "louisiana", "kentucky", "oregon", "oklahoma", "connecticut", "utah", "iowa", "nevada",
    "arkansas", "mississippi", "kansas", "nebraska", "idaho", "new mexico", "west virginia",
    "hawaii", "new hampshire", "maine", "montana", "rhode island", "delaware", "south dakota",
    "north dakota", "alaska", "vermont", "wyoming", "district of columbia", "dc"
}
...
def normalize_dataframe(df: pd.DataFrame, name_column: str = "Account Name") -> pd.DataFrame:
    """
