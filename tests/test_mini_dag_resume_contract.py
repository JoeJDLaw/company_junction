...
class TestMiniDAGResumeContract:
    ...
    def test_resume_from_respects_contract(self, mock_mini_dag_class, mock_run_pipeline):
        ...
        mock_stages = ["normalization", "filtering", "candidate_generation", "grouping", "survivorship"]
        ...
        mock_mini_dag.should_run.side_effect = lambda stage, resume_from: stage in ["grouping", "survivorship"]
