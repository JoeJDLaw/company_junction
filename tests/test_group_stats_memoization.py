    ...
    def test_duckdb_memoization_smoke(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert (
                    t1_meta.get("cache_hit", False) is False
                ...
                assert (
                    t2_meta.get("cache_hit", False) is True
                ...
                assert (
                    t3_meta.get("cache_hit", False) is True
                ), "Third run should be cache hit"
    ...
    def test_duckdb_memoization_different_configs(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert (
                    meta1.get("cache_hit", False) is False
                ), "First config should be cache miss"
                assert (
                    meta2.get("cache_hit", False) is False
                ), "Second config should be cache miss"
                ...
                ), "Repeated first config should be cache hit"
                ...
                ), "Repeated second config should be cache hit"
    ...
    def test_duckdb_memoization_performance_improvement(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert len(df2) > 0, "Second run should produce results"
                assert (
                    meta2.get("cache_hit", False) is True
                ), "Second run should be cache hit"
                ...
                assert (
                    second_run_time < first_run_time * 0.8
                ), f"Cache hit should be faster: {second_run_time:.3f}s vs {first_run_time:.3f}s"
