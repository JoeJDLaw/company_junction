# Cursor Patch Instructions — Update README.md and cursor_rules.md

These patches update documentation to reflect **Phase 1 completion** and ensure `cursor_rules.md` stays the source of truth.
...
You may also want to add a **Phase 1 entry** at the top of `CHANGELOG.md` summarizing the implementation completion, but this can wait until right before Phase 2.
