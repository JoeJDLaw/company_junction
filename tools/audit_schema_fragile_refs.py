...
def main():
    ...
    if all_references:
        ...
        print("- Use context-aware functions: get_order_by(sort_key, context='group_details')")
        print("- Use conditional filtering: _build_where_clause(filters, available_columns)")
